...
public class TorrentInfoRU
{
	...
	public TorrentInfoRU(byte[] torrent_file_bytes) throws BencodingException
	{
		...
		ByteBuffer url_buff = (ByteBuffer)this.torrent_file_map.get(TorrentInfoRU.KEY_ANNOUNCE);
		if(url_buff == null)
		...
		Map<ByteBuffer,Object> info_map = (Map<ByteBuffer,Object>)this.torrent_file_map.get(TorrentInfoRU.KEY_INFO);
		...
		Integer piece_length = (Integer)this.info_map.get(TorrentInfoRU.KEY_PIECE_LENGTH);
		...
		ByteBuffer name_bytes = (ByteBuffer)this.info_map.get(TorrentInfoRU.KEY_NAME);
		if(name_bytes == null)
		...
		Integer file_length = (Integer)this.info_map.get(TorrentInfoRU.KEY_LENGTH);
		if(file_length == null)
		...
		ByteBuffer all_hashes = (ByteBuffer)this.info_map.get(TorrentInfoRU.KEY_PIECES);
		if(all_hashes == null)
	...
	public String toString(){
		...
		String info=(
				"Url: " + announce_url + "\n" +
				"Total length: " + file_length + "\n" +
				"File name: " + file_name + "\n" +
				"Piece length: " + piece_length + "\n");		
		info=info.concat("\nDecoded SSH-1 hash digests in hexidecimal:\n");
		byte[] bytes;
